...
This client connects to the server and trains on client2-data.csv
"""
import flwr as fl
import numpy as np
import pandas as pd
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print("Usage: python client2.py SERVER_ADDRESS")
        print("  Example (local IP): python client2.py 192.168.1.100:8080")
        print("  Example (ngrok): python client2.py 0.tcp.ngrok.io:12345")
    ...
    print("=" * 60)
    print("Federated Learning Client 2 - Crop Price Prediction")
    print("=" * 60)
    ...
    print(f"Training on: client2-data.csv")
    print()
    
    # Create client
    client = FlowerClient(client_id=2, data_file="client2-data.csv")
