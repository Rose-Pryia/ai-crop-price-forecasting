"""
Web interface for Client 1 to add/upload crop data
...
app = FastAPI(title="Client 1 - Crop Data Entry")

# Data file for client 1
CLIENT_DATA_FILE = "client1-data.csv"

HTML_TEMPLATE = """
<!DOCTYPE html>
<html>
<head>
    <title>Client 1 - Crop Data Entry</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <h1>Client 1 - Crop Price Data Entry</h1>
...
if __name__ == "__main__":
    print("Starting Client 1 Web Interface on http://localhost:5002")
